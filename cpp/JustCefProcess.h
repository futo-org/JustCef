...
public:
    ...
    asio::awaitable<std::shared_ptr<JustCefWindow>> CreateWindowAsync(std::string url, int minimum_width, int minimum_height, int preferred_width = 0, int preferred_height = 0,
                                                                      bool fullscreen = false, bool context_menu_enable = false, bool shown = true,
                                                                      bool developer_tools_enabled = false, bool resizable = true, bool frameless = false, bool centered = true,
                                                                      bool proxy_requests = false, bool log_console = false, RequestProxy request_proxy = {},
    ...
    static std::filesystem::path ResolveNativeExecutablePath(const std::optional<std::filesystem::path>& native_executable_path = std::nullopt);
